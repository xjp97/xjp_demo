            ...
            <div class="am-tabs-bd">
              ...
              <%--      <center>
                        <div class="up-img-cover"  id="up-img-touch" >
                            <img class="am-circle" alt="点击图片上传" width="140" height="140" src="${user.profilehead}" data-am-popover="{content: '点击上传', trigger: 'hover focus'}" >
                        </div>
                    </center>
                    ...
                    <form class="am-form am-form-horizontal" action="${ctx}/${userid}/upload" enctype="multipart/form-data" method="post" onsubmit="return checkFileType();" style="text-align: center;">
                        <div style="text-align: center;margin-bottom: 10px">
                            <img class="am-circle" src=${user.profilehead} width="140" height="140" alt="Amayadream"/>
                        </div>
                        ...
                        <button type="submit" class="am-btn am-round am-btn-success"><span class="am-icon-upload"></span> </button>
                        <script>
                            $(function() {
